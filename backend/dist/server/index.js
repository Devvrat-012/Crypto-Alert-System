...
import priceRouter from '../controllers/priceController.js';
import { initializeSockets } from '../sockets/priceSocket.js';
import { loginRouter, registerRouter } from '../controllers/authController.js';
dotenv.config();
const app = express();
app.use(cors());
